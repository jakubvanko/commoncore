...
public enum CCSound {
    ...
    /**
     * Creates a CCSound from a sound name
     *
     * @param sounds Sound strings ?
     */
    CCSound(String... sounds) {
        this.sounds = sounds;
    }
    ...
    /**
     * Creates a CCSound from string
     *
     * @param key String to convert to CCSound
     * @return Converted CCSound
     */
    public static CCSound fromString(String key) {
        CCSound ccSound = null;
        try {
            ccSound = CCSound.valueOf(key);
            return ccSound;
        } catch (IllegalArgumentException e) {
            return requestCCSound(key);
        }

    }

    private static HashMap<String, CCSound> cachedSearch = new HashMap<>();
     ...
     * @return ???
     */
    public static CCSound requestCCSound(String name) {
        if (cachedSearch.containsKey(name.toUpperCase())) {
            return cachedSearch.get(name.toUpperCase());
        }
        for (CCSound sound : CCSound.values()) {
            for (String test : sound.sounds) {
                if (name.toUpperCase().equals(test)) {
                    cachedSearch.put(test, sound);
                    return sound;
                }
            }
        }
    ...
    /**
     * Plays a specified sound to a given player
     *
